...
class _CharacteristicTileState extends State<CharacteristicTile> {
  ...
  Future onReadPressed() async {
    try {
      print("Hello");
      print("characteristics data is: $c");
    final List<int> rawdata= await c.read();
    print("row data is $rawdata");
  ...
  Widget buildUuid(BuildContext context) {
    ...
    return Text(uuid, style: TextStyle(fontSize: 13,color: Colors.white));
  }
